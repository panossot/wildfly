 ...
 */
package org.jboss.as.metrics.component;
...
public class Attachments {
    ...
    public static final AttachmentKey<MetricsCacheSingleton> METRIC_CACHE = AttachmentKey.create(MetricsCacheSingleton.class);
}
